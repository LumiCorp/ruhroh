...
export type RuhrohCompletionNotDoneReason =
  | "agent_requested_continue"
  | "missing_completion_signal"
  | "context_checkpoint"
  | "partial_progress";
export type RuhrohCompletionTerminalFailureReason =
  | "cannot_satisfy"
  | "policy_blocked"
  | "out_of_scope"
  | "runtime_failure"
...
export function adapterSatisfiesRequirements(
  adapter: RuhrohRunAgentAdapterCapabilities,
  requirements: {
    continuity: RuhrohContinuityLevel;
    tools: string[];
    network: boolean;
